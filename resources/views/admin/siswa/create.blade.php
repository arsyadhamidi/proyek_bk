                    ...
                    <div class="card-body">
                                    ...
                                    <div class="col-lg">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="telp_siswa"
                                                ...
                                                placeholder="Masukan telepon siswa" value="{{ old('telp_siswa') }}">
                                            @error('telp_siswa')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="alamat_siswa"
                                        ...
                                        placeholder="Masukan tempat lahir" value="{{ old('alamat_siswa') }}">
                                    @error('alamat_siswa')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nilai_siswa"
                                        ...
                                        value="{{ old('nilai_siswa') }}" placeholder="Optional">
                                    @error('nilai_siswa')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan_siswa" rows="5"
                                class="form-control @error('keterangan_siswa') is-invalid @enderror" placeholder="Optional">{{ old('keterangan_siswa') }}</textarea>
                        </div>
                    </div>
