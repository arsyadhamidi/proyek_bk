...
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('biodata-siswa.update', Auth()->user()->id) }}" method="POST">
                @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg">
                                <input type="text" name="nisn_siswa"
                                    ...
                                    placeholder="Masukan nisn siswa" value="{{ old('nisn_siswa', $siswas->nisn_siswa) }}">
                                @error('nisn_siswa')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg">
                                <input type="text" name="nama_siswa"
                                    ...
                                    placeholder="Masukan nama siswa" value="{{ old('nama_siswa', $siswas->nama_siswa) }}">
                                @error('nama_siswa')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg">
                                <textarea name="alamat_siswa" class="form-control @error('alamat_siswa') is-invalid @enderror" rows="4"
                                    placeholder="Masukan alamat domisili">{{ old('alamat_siswa', $siswas->alamat_siswa) }}</textarea>
                                @error('alamat_siswa')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
