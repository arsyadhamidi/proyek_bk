                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status_bimbingan"
                                        ...
                                        style="width: 100%;" id="idStatusBimbingan">
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <textarea name="keterangan_bimbingan" class="form-control @error('keterangan_bimbingan') is-invalid @enderror"
                                        rows="5" placeholder="Masukan keluhan yang dialami" id="editor">{{ old('keterangan_bimbingan') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
